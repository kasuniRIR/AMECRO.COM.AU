                    ...
                    <div class="col-sm-6">
                        <div class="text-icon-hor">
                            ...
                            <div class="text-icon-hor-text">
                                <h3>Our Mission</h3>
                                <p>Aims to be a national market leader in the provision of cleaning services delivering
                                    reliable, quality, cost effective cleaning solutions to our customers</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="text-icon-hor">
                            ...
                            <div class="text-icon-hor-text">
                                <h3>Our Vision</h3>
                                <p>We have more than 215 franchise locations across the United States and Canada. All of
                                    them are committed to the same common values and principles.</p>
                            </div>
                        </div>
                    </div>
                </div>
