            ...
            <div class="container">
                ...
                <div class="tab-content tab-content-nopad">
                    ...
                    <div role="tabpanel" class="tab-pane" id="tab2">
                        <h5><span class="rating"><i class="icon-star-black"></i><i class="icon-star-black"></i><i
                                    class="icon-star-black"></i><i class="icon-star-black"></i><i
                                    class="icon-star-black"></i></span>Joseph C. Lane</h5>
                        ...
                        <h5><span class="rating"><i class="icon-star-black"></i><i class="icon-star-black"></i><i
                                    class="icon-star-black"></i><i class="icon-star-black"></i><i
                                    class="icon-star-black"></i></span>Jenny M. Fischer</h5>
