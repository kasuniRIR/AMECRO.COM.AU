...
<head>
    ...
    <title>ADMIN PANEL - VIEW ENV SOLUTIONS</title>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <center>
                    <h1 class="h3 mb-1 text-gray-800">View Environmental Solutions</h1>
                </center><br>
                        ...
                        <table class="table table-bordered">
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="php_code.php?e_del=<?php echo $row['e_id']; ?>" class="del_btn"><i class="fa fa-trash" style="color:grey"></i></a>
                                        </td>
                                    </tr>
