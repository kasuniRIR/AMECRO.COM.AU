                            ...
                            <div class="row">
                                <div class="col-md-offset-1"><br>
                                    <div class="col-13">
                                        ...
                                        <input type="text" name="k_name" class="form-control" value="<?php echo $k_name ?>" required>
                                    </div><br>
                                    <div class="col-13">
                                        <label>Product Model</label>
                                        <input type="text" name="k_model" class="form-control" value="<?php echo $k_model ?>" required>
                                    </div><br>
                                    <div class="col-13">
                                        <label>Product Size</label>
                                        <input type="text" name="k_size" class="form-control" value="<?php echo $k_size ?>" required>
                                    </div><br>
                                </div>
                            </div>
