...
<head>
    ...
    <title>ADMIN PANEL - ADD ENV SOLUTIONS</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid" style="width: 1300px;">
                    <!-- Page Heading -->
                    <center>
                        <h1 class="h3 mb-1 text-gray-800">ADD ENVIRONMENTAL SOLUTIONS</h1>
                    </center>

                    <form method="post" action="viewEnvironmentalDashboard.php" enctype="multipart/form-data" style="width: 60%">
                        <div class="row">
                        ...
                        <div class="col-md-20">
                            <button type="submit" name="environmental" class="btn btn-primary">Add</button>
                        </div>
